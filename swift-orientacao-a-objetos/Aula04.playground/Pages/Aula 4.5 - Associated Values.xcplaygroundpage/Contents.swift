...
contaAnna.pagamentoCartao(.pix)
contaAnna.pagamentoCartao(FormaDePagamento.boleto)
contaAnna.depositar(100)
let resultado = contaAnna.sacar(20)
switch resultado {
case .sucesso(let novoValor): print("O saque foi um sucesso, e o saldo é de \(novoValor)")
